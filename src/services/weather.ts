    ...
    daily: [
      {
        ...
        humidity: 60,
        hourlyForecasts: [
          { time: '8 AM', temp: 58, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 63, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 67, precipitation: 15, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 14 },
          { time: '5 PM', temp: 65, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 17 },
        ]
      },
      {
        date: 'Tomorrow',
        ...
        humidity: 92,
        hourlyForecasts: [
          { time: '8 AM', temp: 52, precipitation: 90, icon: '11d', description: 'thunderstorm with heavy rain', rainAmount: 8.5, hour24: 8 },
          { time: '11 AM', temp: 55, precipitation: 95, icon: '11d', description: 'thunderstorm with heavy rain', rainAmount: 9.2, hour24: 11 },
          { time: '2 PM', temp: 58, precipitation: 85, icon: '10d', description: 'heavy intensity rain', rainAmount: 7.1, hour24: 14 },
          { time: '5 PM', temp: 56, precipitation: 80, icon: '10d', description: 'heavy intensity rain', rainAmount: 6.8, hour24: 17 },
        ]
      },
      {
        date: 'Wed',
        ...
        humidity: 80,
        hourlyForecasts: [
          { time: '8 AM', temp: 55, precipitation: 80, icon: '10d', description: 'moderate rain', rainAmount: 3.2, hour24: 8 },
          { time: '11 AM', temp: 60, precipitation: 70, icon: '10d', description: 'light rain', rainAmount: 1.8, hour24: 11 },
          { time: '2 PM', temp: 66, precipitation: 20, icon: '03d', description: 'scattered clouds', rainAmount: 0.2, hour24: 14 },
          { time: '5 PM', temp: 68, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 17 },
        ]
      },
      {
        date: 'Thu',
        ...
        humidity: 75,
        hourlyForecasts: [
          { time: '8 AM', temp: 60, precipitation: 10, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 68, precipitation: 15, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 74, precipitation: 85, icon: '10d', description: 'moderate rain', rainAmount: 4.2, hour24: 14 },
          { time: '5 PM', temp: 70, precipitation: 90, icon: '10d', description: 'heavy rain', rainAmount: 5.5, hour24: 17 },
        ]
      },
      {
        date: 'Fri',
        ...
        humidity: 55,
        hourlyForecasts: [
          { time: '8 AM', temp: 57, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 62, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 68, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 14 },
          { time: '5 PM', temp: 70, precipitation: 10, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 17 },
        ]
      }
    ]
  };
