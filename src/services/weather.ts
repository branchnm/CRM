  ...
  return {
    ...
    daily: [
      ...
      },
      {
        ...
        humidity: 75,
        hourlyForecasts: [
          { time: '8 AM', temp: 62, precipitation: 75, icon: '10d', description: 'light rain', rainAmount: 2.8, hour24: 8 },
          { time: '11 AM', temp: 68, precipitation: 60, icon: '09d', description: 'light drizzle', rainAmount: 1.2, hour24: 11 },
          { time: '2 PM', temp: 72, precipitation: 15, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 14 },
          { time: '5 PM', temp: 74, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 17 },
        ]
      },
      {
        date: 'Wed',
        ...
        humidity: 55,
        hourlyForecasts: [
          { time: '8 AM', temp: 64, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 70, precipitation: 15, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 76, precipitation: 20, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 14 },
          { time: '5 PM', temp: 75, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 17 },
        ]
      },
      {
        date: 'Thu',
        ...
        humidity: 80,
        hourlyForecasts: [
          { time: '8 AM', temp: 63, precipitation: 10, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 68, precipitation: 20, icon: '03d', description: 'scattered clouds', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 72, precipitation: 30, icon: '04d', description: 'overcast clouds', rainAmount: 0.5, hour24: 14 },
          { time: '5 PM', temp: 70, precipitation: 85, icon: '10d', description: 'moderate rain', rainAmount: 4.5, hour24: 17 },
          { time: '8 PM', temp: 66, precipitation: 90, icon: '10d', description: 'heavy rain', rainAmount: 6.8, hour24: 20 },
          { time: '11 PM', temp: 63, precipitation: 85, icon: '10d', description: 'moderate rain', rainAmount: 5.2, hour24: 23 },
        ]
      },
      {
        date: 'Fri',
        ...
        humidity: 60,
        hourlyForecasts: [
          { time: '8 AM', temp: 61, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 66, precipitation: 15, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 71, precipitation: 10, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 14 },
          { time: '5 PM', temp: 70, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 17 },
        ]
      }
    ]
  };
