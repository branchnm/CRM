  ...
  return {
    ...
    daily: [
      ...
      },
      {
        ...
        humidity: 75,
        hourlyForecasts: [
          { time: '8 AM', temp: 55, precipitation: 65, icon: '10d', description: 'light rain', rainAmount: 2.5, hour24: 8 },
          { time: '11 AM', temp: 60, precipitation: 50, icon: '09d', description: 'light drizzle', rainAmount: 0.8, hour24: 11 },
          { time: '2 PM', temp: 66, precipitation: 20, icon: '03d', description: 'scattered clouds', rainAmount: 0, hour24: 14 },
      ...
      },
      {
        ...
        humidity: 55,
        hourlyForecasts: [
          { time: '8 AM', temp: 60, precipitation: 0, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 8 },
          { time: '11 AM', temp: 68, precipitation: 5, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 11 },
          { time: '2 PM', temp: 74, precipitation: 0, icon: '01d', description: 'clear sky', rainAmount: 0, hour24: 14 },
          { time: '5 PM', temp: 72, precipitation: 0, icon: '02d', description: 'partly cloudy', rainAmount: 0, hour24: 17 },
        ]
      },
      {
        date: 'Fri',
        ...
        humidity: 82,
        hourlyForecasts: [
          { time: '8 AM', temp: 57, precipitation: 80, icon: '10d', description: 'moderate rain', rainAmount: 4.2, hour24: 8 },
          { time: '11 AM', temp: 62, precipitation: 75, icon: '10d', description: 'moderate rain', rainAmount: 3.8, hour24: 11 },
          { time: '2 PM', temp: 66, precipitation: 70, icon: '10d', description: 'moderate rain', rainAmount: 3.5, hour24: 14 },
          { time: '5 PM', temp: 64, precipitation: 65, icon: '10d', description: 'moderate rain', rainAmount: 3.2, hour24: 17 },
        ]
      }
    ]
  };
